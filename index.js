...
console.log(variables_js_1.x);
const someImports_1 = require("./someImports");
console.log(someImports_1.a);
console.log(someImports_1.b);
(0, someImports_1.myFunction)();
...
const someUser = new User("joao", 32);
